...
liquibase --driver=com.microsoft.sqlserver.jdbc.SQLServerDriver --classpath=./libstatic/sqljdbc4.1.jar --changeLogFile=./src/main/resources/db/db_1.0.xml --url="jdbc:sqlserver://localhost\SQLEXPRESS2014;DatabaseName=mlasaf02" --logLevel=DEBUG --username="sa" --password="sapass" migrate
