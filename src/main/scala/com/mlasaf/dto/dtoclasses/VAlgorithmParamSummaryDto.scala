...
case class VAlgorithmParamSummaryDto ( 
   ...
   def fields : String = {    "algorithmParamId,guid,insertedRowDate,lastUpdatedDate,algorithmParamName,algorithmParamDescription,algorithmParamType,algorithmParamType_count,algorithmScheduleParam_count";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
 ...
 def toAnyArray() : Array[Any] = {    Array(algorithmParamId,guid,insertedRowDate,lastUpdatedDate,algorithmParamName,algorithmParamDescription,algorithmParamType,algorithmParamType_count,algorithmScheduleParam_count)  }  
 def toStringArray() : Array[String] = {    Array(""+algorithmParamId,""+guid,""+insertedRowDate,""+lastUpdatedDate,""+algorithmParamName,""+algorithmParamDescription,""+algorithmParamType,""+algorithmParamType_count,""+algorithmScheduleParam_count)   }  
 def toJson() : String = {   "{" + "\"algorithmParamId\":\""+algorithmParamId+"\""+","+"\"guid\":\""+guid+"\""+","+"\"insertedRowDate\":\""+insertedRowDate+"\""+","+"\"lastUpdatedDate\":\""+lastUpdatedDate+"\""+","+"\"algorithmParamName\":\""+algorithmParamName+"\""+","+"\"algorithmParamDescription\":\""+algorithmParamDescription+"\""+","+"\"algorithmParamType\":\""+algorithmParamType+"\""+","+"\"algorithmParamType_count\":\""+algorithmParamType_count+"\""+","+"\"algorithmScheduleParam_count\":\""+algorithmScheduleParam_count+"\"" + "}"   }  
