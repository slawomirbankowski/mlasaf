...
case class VExecutorHostSummaryDto ( 
   ...
   def fields : String = {    "executorHostId,guid,insertedRowDate,lastUpdatedDate,hostName,hostIp,hostDomain,hostOsType,hostOsVersion,isWorking,executorRest_count,executorRestCall_count,executorInstance_count,sourceDownload_count,executorStorage_count,resourceManager_count,executorContext_count,resourceManagerCheck_count,resourceManagerAllocation_count,executorContextRuntime_count,executorTypeHostParam_count";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
 ...
 def toJson() : String = {   "{" + "\"executorHostId\":\""+executorHostId+"\""+","+"\"guid\":\""+guid+"\""+","+"\"insertedRowDate\":\""+insertedRowDate+"\""+","+"\"lastUpdatedDate\":\""+lastUpdatedDate+"\""+","+"\"hostName\":\""+hostName+"\""+","+"\"hostIp\":\""+hostIp+"\""+","+"\"hostDomain\":\""+hostDomain+"\""+","+"\"hostOsType\":\""+hostOsType+"\""+","+"\"hostOsVersion\":\""+hostOsVersion+"\""+","+"\"isWorking\":\""+isWorking+"\""+","+"\"executorRest_count\":\""+executorRest_count+"\""+","+"\"executorRestCall_count\":\""+executorRestCall_count+"\""+","+"\"executorInstance_count\":\""+executorInstance_count+"\""+","+"\"sourceDownload_count\":\""+sourceDownload_count+"\""+","+"\"executorStorage_count\":\""+executorStorage_count+"\""+","+"\"resourceManager_count\":\""+resourceManager_count+"\""+","+"\"executorContext_count\":\""+executorContext_count+"\""+","+"\"resourceManagerCheck_count\":\""+resourceManagerCheck_count+"\""+","+"\"resourceManagerAllocation_count\":\""+resourceManagerAllocation_count+"\""+","+"\"executorContextRuntime_count\":\""+executorContextRuntime_count+"\""+","+"\"executorTypeHostParam_count\":\""+executorTypeHostParam_count+"\"" + "}"   }  
