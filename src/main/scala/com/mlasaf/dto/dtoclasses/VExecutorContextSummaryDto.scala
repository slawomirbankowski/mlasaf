...
case class VExecutorContextSummaryDto ( 
   ...
   def fields : String = {    "executorContextId,guid,insertedRowDate,lastUpdatedDate,executorHostId,isWorking,properties,properties2,properties3,entryParams,executorContextState_count,executorContextThread_count,executorContextCommand_count,executorContextRuntime_count,executorInstance_count,sourceDownload_count";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
 ...
 def toJson() : String = {   "{" + "\"executorContextId\":\""+executorContextId+"\""+","+"\"guid\":\""+guid+"\""+","+"\"insertedRowDate\":\""+insertedRowDate+"\""+","+"\"lastUpdatedDate\":\""+lastUpdatedDate+"\""+","+"\"executorHostId\":\""+executorHostId+"\""+","+"\"isWorking\":\""+isWorking+"\""+","+"\"properties\":\""+properties+"\""+","+"\"properties2\":\""+properties2+"\""+","+"\"properties3\":\""+properties3+"\""+","+"\"entryParams\":\""+entryParams+"\""+","+"\"executorContextState_count\":\""+executorContextState_count+"\""+","+"\"executorContextThread_count\":\""+executorContextThread_count+"\""+","+"\"executorContextCommand_count\":\""+executorContextCommand_count+"\""+","+"\"executorContextRuntime_count\":\""+executorContextRuntime_count+"\""+","+"\"executorInstance_count\":\""+executorInstance_count+"\""+","+"\"sourceDownload_count\":\""+sourceDownload_count+"\"" + "}"   }  
