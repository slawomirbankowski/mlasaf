...
case class VAlgorithmVersionSummaryDto ( 
   ...
   def fields : String = {    "algorithmVersionId,insertedRowDate,lastUpdatedDate,guid,algorithmTypeId,algorithmVersionName,algorithmImplementation_count,algorithmVersionParamType_count,algorithmVersionColumnType_count,algorithmVersionOutputType_count";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
 ...
 def toAnyArray() : Array[Any] = {    Array(algorithmVersionId,insertedRowDate,lastUpdatedDate,guid,algorithmTypeId,algorithmVersionName,algorithmImplementation_count,algorithmVersionParamType_count,algorithmVersionColumnType_count,algorithmVersionOutputType_count)  }  
 def toStringArray() : Array[String] = {    Array(""+algorithmVersionId,""+insertedRowDate,""+lastUpdatedDate,""+guid,""+algorithmTypeId,""+algorithmVersionName,""+algorithmImplementation_count,""+algorithmVersionParamType_count,""+algorithmVersionColumnType_count,""+algorithmVersionOutputType_count)   }  
 def toJson() : String = {   "{" + "\"algorithmVersionId\":\""+algorithmVersionId+"\""+","+"\"insertedRowDate\":\""+insertedRowDate+"\""+","+"\"lastUpdatedDate\":\""+lastUpdatedDate+"\""+","+"\"guid\":\""+guid+"\""+","+"\"algorithmTypeId\":\""+algorithmTypeId+"\""+","+"\"algorithmVersionName\":\""+algorithmVersionName+"\""+","+"\"algorithmImplementation_count\":\""+algorithmImplementation_count+"\""+","+"\"algorithmVersionParamType_count\":\""+algorithmVersionParamType_count+"\""+","+"\"algorithmVersionColumnType_count\":\""+algorithmVersionColumnType_count+"\""+","+"\"algorithmVersionOutputType_count\":\""+algorithmVersionOutputType_count+"\"" + "}"   }  
