...
case class VDownloadTransformDto ( 
   ...
   def fields : String = {    "downloadTransformId,guid,insertedRowDate,lastUpdatedDate,downloadTransformTypeId,downloadTransformGroupId,downloadTransformDefinition,downloadTransformGroup_downloadTransformGroupId,downloadTransformGroup_guid,downloadTransformGroup_insertedRowDate,downloadTransformGroup_lastUpdatedDate,downloadTransformGroup_downloadTransformGroupName,downloadTransformType_downloadTransformTypeId,downloadTransformType_guid,downloadTransformType_insertedRowDate,downloadTransformType_lastUpdatedDate,downloadTransformType_downloadTransformTypeName";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
