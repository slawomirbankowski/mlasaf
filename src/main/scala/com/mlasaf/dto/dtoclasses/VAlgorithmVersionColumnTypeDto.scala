...
case class VAlgorithmVersionColumnTypeDto ( 
   ...
   def fields : String = {    "algorithmVersionColumnTypeId,guid,insertedRowDate,lastUpdatedDate,algorithmVersionId,algorithmColumnTypeId,allowMultiple,allowEmpty,algorithmColumnType_algorithmColumnTypeId,algorithmColumnType_guid,algorithmColumnType_insertedRowDate,algorithmColumnType_lastUpdatedDate,algorithmColumnType_algorithmColumnTypeName,algorithmColumnType_algorithmColumnTypeDescription,algorithmVersion_algorithmVersionId,algorithmVersion_insertedRowDate,algorithmVersion_lastUpdatedDate,algorithmVersion_guid,algorithmVersion_algorithmTypeId,algorithmVersion_algorithmVersionName";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
